  ...
  return useInfiniteQuery({
    ...
    queryFn: ({ pageParam }) =>
      api.listIssues(companyId, {
        // Default newest-first; a caller-supplied filters.sortDir overrides it.
        // sortField stays "updated" (the only field the server accepts), and
        // limit/offset are fixed last so filters can't break pagination.
        sortDir: "desc",
        ...filters,
        sortField: "updated",
        limit: ISSUES_PAGE,
