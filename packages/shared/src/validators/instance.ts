...
export const instanceExperimentalSettingsSchema = z.object({
  ...
  // Hands-free ElevenLabs voice for Mergatroid (<REDACTED_ORG> HQ). Gates the /hq "Call" tab and the
  // /board/oversight/voice/* routes. Independent of enableConferenceRoomChat so voice can ship separately.
  enableVoiceChat: z.boolean().default(false),
