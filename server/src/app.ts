...
import { internalMemoryMcpRoutes } from "./routes/internal-memory-mcp.js";
...
import { instanceDashboardRoutes } from "./routes/instance-dashboard.js";
...
export async function createApp(
  ...
  api.use(internalMemoryMcpRoutes(db));
  ...
  api.use(instanceDashboardRoutes(db));
