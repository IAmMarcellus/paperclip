...
import { RedactedOrgHQ } from "./pages/RedactedOrgHQ";
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="onboarding" element={<OnboardingRoutePage />} />
          {/* <REDACTED_ORG> HQ — instance-wide oversight destination (Mergatroid). Unprefixed/global
              (see GLOBAL_ROUTE_ROOTS) so it renders without a company Layout; gated by the same
              experimental flag as the per-company Conference Room. */}
          <Route element={<ConferenceRoomChatGate />}>
            <Route path="hq" element={<RedactedOrgHQ />} />
          </Route>
