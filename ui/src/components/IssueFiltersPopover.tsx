...
import { Bot, Filter, HardDrive, MessageSquare, Search, User, X } from "lucide-react";
            ...
            <div className="min-w-0 space-y-3">
              ...
              <div className="space-y-1">
                ...
                {enableCommentedByMeFilter ? (
                  <label className="flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1 hover:bg-accent/50">
                    <Checkbox
                      checked={state.commentedByMe === true}
                      onCheckedChange={(checked) => onChange({ commentedByMe: checked === true })}
                    />
                    <MessageSquare className="h-3.5 w-3.5 text-muted-foreground" />
                    <span className="text-sm">Commented on by me</span>
                  </label>
                ) : null}
                <label className="flex cursor-pointer items-center gap-2 rounded-sm px-2 py-1 hover:bg-accent/50">
                  <Checkbox
