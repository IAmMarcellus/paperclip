...
import { AgentChip } from "../components/aurora";
...
export function Dashboard() {
  ...
  return (
    <div className="space-y-6">
      ...
      {hasNoAgents && (
        <div className="flex items-center justify-between gap-3 rounded-xl border border-amber-400/25 bg-amber-400/10 px-4 py-3">
      ...
      {data && (
        <>
          ...
          <PluginSlotOutlet
            ...
            itemClassName="glass rounded-xl p-4"
          />
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            {recentActivity.length > 0 && (
              <div className="min-w-0">
                <h3 className="mb-3 font-mono text-[11px] font-medium uppercase tracking-[0.12em] text-muted-foreground">
                  Recent Activity
                </h3>
                        ...
                        <span className="flex min-w-0 flex-1 flex-col gap-1 sm:contents">
                          ...
                          <span className="flex items-center gap-2 sm:order-1 sm:shrink-0">
                            ...
                            {issue.assigneeAgentId && (() => {
                              ...
                              return name
                                ? <span className="hidden sm:inline-flex"><AgentChip agent={{ id: issue.assigneeAgentId, name }} name={name} className="text-xs" /></span>
                                : null;
                            })()}
